...
import AddAgentSocialMedia from '../../Form/FormAddAgentSocialMedia';
import FormEditAgentSocialMedia from '../../Form/FormEditAgentSocialMedia';

export class AllAgentSocialMedia extends React.Component{
    render(){
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="block">
                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12   block">
                                                <button className="btn btn-primary pull-right col-lg-2 col-md-2 col-sm-2 col-xs-12  btn-sm" data-target="#modal-fadein" data-toggle="modal"> <i className="fa fa-plus text-white"></i> Add Agent</button>
                                            </div>
