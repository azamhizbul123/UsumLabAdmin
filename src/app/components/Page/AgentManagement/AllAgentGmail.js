...
export class AllAgentGmail extends React.Component{
    render(){
                                                    ...
                                                    <div className="col-lg-12">
                                                        <a className="block block-link-hover2">
                                                            <div className="block-content block-content-full bg-primary clearfix">
                                                                ...
                                                                <button className="btn btn-default btn-xs pull-right cs-btn-transparent" data-target="#modal-fadein-detail" data-toggle="modal">Detail</button>
                                                            </div>
                                                        </a>
                                                    </div>
