...
import FormAgentConditionSocialMeda from "../../Form/FormAgentConditionSocialMedia";
import FormEditGmailPortal from "../../Form/FormEditGmailPortal";
import FormDropAgentSocialMedia from "../../Form/FormDropAgentSocialMedia";
import store from "../../Form/store";
import ShowResults from "../../Form/showResult";

import {BootstrapTable, TableHeaderColumn} from "react-bootstrap-table";
import '../../../../../node_modules/react-bootstrap-table/dist/react-bootstrap-table-all.min.css';
export class ConditionAgentNewsPortal extends React.Component{
                        ...
                        <div className="row items-push">
                            <div className="col-sm-7">
                                <h1 className="page-heading">
                                    Agent News Portal Condition
                                </h1>
                            </div>
                            <div className="col-sm-5 text-right hidden-xs">
                                <ol className="breadcrumb push-10-t">
                                    <li>Home</li>
                                    <li><a className="link-effect" href="">Agent News Portal Condition</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-lg-12 cs-background-white block block-bordered">
                                    <div className="row">
                                        <div className=" block-header">
                                            <h5>Search Agent Name</h5>
                                        </div>

                                        <div className="block-content">
                                            <Provider store={store}>
                                                <FormDropAgentSocialMedia/>
                                            </Provider>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="block">
                                            ...
                                            <div className="block-content">
                                                ...
                                                <BootstrapTable data={products} striped={false} hover={true} search>
                                                    ...
                                                    <TableHeaderColumn dataField="name" dataAlign="center">Connection Type</TableHeaderColumn>
                                                    <TableHeaderColumn dataField="price" dataAlign="center">Term</TableHeaderColumn>
                                                ...
                                                <div className="modal-footer cs-modal-footer">
                                                    <button className="btn btn-sm btn-default" type="button">Cancel</button>
                                                    <button className="btn btn-sm btn-primary" type="submit" >Save & Run</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="modal-content">
                            <div className="block block-themed block-transparent remove-margin-b">
                                ...
                                <div className="modal-body">
                                    <Provider store={store}>
                                        <div>
                                            <FormAgentConditionSocialMeda onSubmit={ShowResults}/>
                                        </div>
