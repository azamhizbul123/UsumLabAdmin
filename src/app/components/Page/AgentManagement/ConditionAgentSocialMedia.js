...
export class ConditionAgentSocialMedia extends React.Component{
                        ...
                        <div className="row items-push">
                            <div className="col-sm-7">
                                <h1 className="page-heading">
                                    Agent Social Media Condition
                                </h1>
                            </div>
                            <div className="col-sm-5 text-right hidden-xs">
                                <ol className="breadcrumb push-10-t">
                                    <li>Home</li>
                                    <li><a className="link-effect" href="">Agent Social Media Condition
                                    </a></li>
                                </ol>
                            </div>
                        </div>
