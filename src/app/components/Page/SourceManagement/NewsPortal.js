...
import FormNewsPortal from "../../Form/FormNewsPortal";
import FormEditNewsPortal from "../../Form/FormEditNewsPortal";
import store from "../../Form/store";
import ShowResults from "../../Form/showResult";

import {BootstrapTable, TableHeaderColumn} from "react-bootstrap-table";
import '../../../../../node_modules/react-bootstrap-table/dist/react-bootstrap-table-all.min.css';
export class NewsPortal extends React.Component{
                            ...
                            <div className="col-lg-12">
                                ...
                                <div className="col-lg-12 cs-background-white block block-bordered">
                                    ...
                                    <div className="block-header bg-primary-dark text-white-op">
                                        <h5>Table News Portal Administratif Tools </h5>
                                    </div>
                                    <div className="block">
                            ...
                            <div className="block block-themed block-transparent remove-margin-b">
                                ...
                                <div className="modal-body">
                                    <Provider store={store}>
                                        <div>
                                            <FormNewsPortal onSubmit={ShowResults}/>
                                        </div>
                        ...
                        <div className="modal-content">
                            <div className="block block-themed block-transparent remove-margin-b">
                                ...
                                <div className="modal-body">
                                    <Provider store={store}>
                                        <div>
                                            <FormEditNewsPortal onSubmit={ShowResults}/>
                                        </div>
