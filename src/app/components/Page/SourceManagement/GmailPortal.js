...
import FormGmailPortal from "../../Form/FormGmailPortal";
...
export class GmailPortal extends React.Component{
                        ...
                        <div className="row items-push">
                            <div className="col-sm-7">
                                <h1 className="page-heading">
                                    Gmail Administratif Tools
                                </h1>
                            </div>
                            <div className="col-sm-5 text-right hidden-xs">
                                <ol className="breadcrumb push-10-t">
                                    <li>Home</li>
                                    <li><a className="link-effect" href="">Gmail Administratif Tools
                                    </a></li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-12">
                                ...
                                <div className="col-lg-12 cs-background-white block block-bordered">
                                    ...
                                    <div className="block-header bg-primary-dark text-white-op">
                                        <h5>Table Gmail Administratif Tools </h5>
                                    </div>
                                    <div className="block">
                            ...
                            <div className="block block-themed block-transparent remove-margin-b">
                                ...
                                <div className="modal-body">
                                    <Provider store={store}>
                                        <div>
                                            <FormGmailPortal onSubmit={ShowResults}/>
                                        </div>
                        ...
                        <div className="modal-content">
                            <div className="block block-themed block-transparent remove-margin-b">
                                ...
                                <div className="modal-body">
                                    <Provider store={store}>
                                        <div>
                                            <FormEditGmailPortal onSubmit={ShowResults}/>
                                        </div>
